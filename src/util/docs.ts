...
export async function classRunner(this: Client, interaction: CommandInteraction, className: string, version: string) {
...
export async function eventRunner(this: Client, interaction: CommandInteraction, className: string, eventName: string, version: string) {
    const data = await getVersion(version);
    if (data === null) {
        return void handleIssue("invalid", interaction, version, false, className, null);
    }
...
export async function classPropertyRunner(this: Client, interaction: CommandInteraction, className: string, propertyName: string, version: string) {
    const data = await getVersion(version);
    if (data === null) {
        return void handleIssue("invalid", interaction, version, false, className, null);
    }
...
export async function interfacePropertyRunner(this: Client, interaction: CommandInteraction, interfaceName: string, propertyName: string, version: string) {
    const data = await getVersion(version);
    if (data === null) {
...
export async function methodRunner(this: Client, interaction: CommandInteraction, className: string, eventName: string, version: string) {
    const data = await getVersion(version);
    if (data === null) {
        return void handleIssue("invalid", interaction, version, false, className, null);
    }
...
export async function typeRunner(this: Client, interaction: CommandInteraction, name: string, version: string) {
    const data = await getVersion(version);
    if (data === null) {
