...
import { type Client, type CommandInteraction, type CreateApplicationCommandOptions, type CreateGuildApplicationCommandOptions, MessageFlags } from "oceanic.js";
...
export default class Commands {
    ...
    static async handle(client: Client, interaction: CommandInteraction): Promise<void> {
    ...
    static async register(client: Client): Promise<void> {
        const commands = this.toJSON() as Array<CreateGuildApplicationCommandOptions>;
    ...
    static toJSON(): Array<CreateApplicationCommandOptions> {
